...
local function set_float_size(conf)
  ...
  return vim.tbl_deep_extend(
    "force",
    conf,
    { row = center_y, col = center_x, width = window_w_int, height = window_h_int }
  )
end

local M = {
  "stevearc/oil.nvim",
  keys = { { "<leader>e", "<cmd>Oil --float<cr>", desc = "Oil" } },
}
